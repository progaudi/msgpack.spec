...
namespace ProGaudi.MsgPack.Light
{
    ...
    public static partial class MsgPackBinary
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint ReadFixUInt32(ReadOnlySpan<byte> buffer, out int readSize) => TryReadFixUInt32(buffer, out var result, out readSize)
            ? result
            : throw new InvalidOperationException();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int WriteUInt32(Span<byte> buffer, uint value) => TryWriteUInt32(buffer, value, out var wroteSize)
            ? wroteSize
            : throw new InvalidOperationException();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint ReadUInt32(ReadOnlySpan<byte> buffer, out int readSize) => TryReadUInt32(buffer, out var value, out readSize)
            ? value
            : throw new InvalidOperationException();
