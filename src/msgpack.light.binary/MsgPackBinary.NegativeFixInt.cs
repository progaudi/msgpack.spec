...
namespace ProGaudi.MsgPack.Light
{
    ...
    public static partial class MsgPackBinary
    {
        ...
        public static int WriteNegativeFixInt(Span<byte> buffer, sbyte value) => TryWriteNegativeFixInt(buffer, value, out var wroteSize)
            ? wroteSize
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte ReadNegativeFixInt(ReadOnlySpan<byte> buffer, out int readSize) => TryReadNegativeFixInt(buffer, out var result, out readSize)
            ? result
            : throw new InvalidOperationException();
