...
namespace ProGaudi.MsgPack.Light.Tests.Reader
{
    public class Integers
    {
        ...
        {
            MsgPackBinary.ReadInt64(data, out var readSize).ShouldBe(number);
        ...
        {
            MsgPackBinary.ReadInt32(data, out var readSize).ShouldBe(number);
            readSize.ShouldBe(data.Length);
        }
        ...
        {
            MsgPackBinary.ReadInt16(data, out var readSize).ShouldBe(number);
            readSize.ShouldBe(data.Length);
        }
        ...
        {
            MsgPackBinary.ReadUInt64(data, out var readSize).ShouldBe(number);
            readSize.ShouldBe(data.Length);
        }
        ...
        {
            MsgPackBinary.ReadUInt32(data, out var readSize).ShouldBe(number);
            readSize.ShouldBe(data.Length);
        }
        ...
        {
            MsgPackBinary.ReadUInt16(data, out var readSize).ShouldBe(number);
            readSize.ShouldBe(data.Length);
        }
