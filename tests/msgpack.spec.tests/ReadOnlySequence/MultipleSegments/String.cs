...
namespace ProGaudi.MsgPack.Tests.ReadOnlySequence.MultipleSegments
{
    public sealed class String
    {
        ...
        {
            MsgPackSpec.TryReadString(data.ToMultipleSegments(), out var actual, out var readSize).ShouldBeTrue();
            actual.ShouldBe(s);
        ...
        {
            MsgPackSpec.ReadString(data.ToMultipleSegments(), out var readSize).ShouldBe(s);
            readSize.ShouldBe(data.Length);
        }
    }
}
